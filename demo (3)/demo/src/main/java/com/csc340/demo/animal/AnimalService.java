...
public class AnimalService {
    ...
    public Entity getAnimalById(int animalId) {
        return animalRepository.findById(animalId).orElse(null);
    }

    public void addNewAnimal(Entity animal) {
        animalRepository.save(animal);
    }

    public void updateAnimal(int animalId, Entity animal) {
        Entity existing = getAnimalById(animalId);
        if (existing != null) {
    ...
    public List<Entity> getAnimalsBySpecies(String species) {
